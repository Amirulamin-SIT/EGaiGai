...
$products = getAllItem($current_page, $num_products_on_each_page);
// Get the total number of products


$total_products = mysqli_num_rows(getAllItemNoLimit());
$product_retrieved = mysqli_num_rows(getAllItem($current_page, $num_products_on_each_page));
?>
